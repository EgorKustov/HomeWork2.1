...
public class DebtCardTest {
    ...
    void shouldBePositiveTest() {
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Кустов-Егор Алексеевич");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79206544565");
